...
public class FormField {
    ...
    protected String elementNumber;
    @XmlAttribute(required = true)
    @XmlJavaTypeAdapter(NormalizedStringAdapter.class)
    ...
    @XmlElement(name = "FormFieldValue")
    protected List<FormFieldValue> formFieldValue;
    ...
    /**
     * Gets the value of the formFieldValue property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the formFieldValue property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getFormFieldValue().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<FormFieldValue> getFormFieldValue() {
        if (formFieldValue == null) {
            formFieldValue = new ArrayList<FormFieldValue>();
        }
